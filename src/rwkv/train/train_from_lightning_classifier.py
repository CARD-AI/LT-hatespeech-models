...
def main():
    ...
    parser.add_argument('--train_file', type=str, default='datasets/train_2.csv')
    parser.add_argument('--test_file', type=str, default='datasets/test_2.csv')
    parser.add_argument('--model_path', type=str, default='model/raven-0.4b-world')
    parser.add_argument('--tokenizer_file', type=str, default='rwkv_vocab_v20230424.txt')
    parser.add_argument('--device', type=str, default='gpu')
    parser.add_argument('--batch_size', type=int, default=1)
    parser.add_argument('--num_devices', type=int, default=1)
    parser.add_argument('--num_classes', type=int, default=3)
    parser.add_argument('--max_length', type=int, default=2048)
    parser.add_argument('--max_epoches', type=int, default=9)
    parser.add_argument('--accumulate_grad_batches', type=int, default=4)
    parser.add_argument('--ckpt_path', type=str, default=None)
    parser.add_argument('--strategy',type=str,default='deepspeed_stage_2_offload')
    parser.add_argument('--is_adalora',action='store_true',default=True)
