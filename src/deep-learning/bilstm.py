...
print("Building model...")
model = Sequential()
model.add(Embedding(len(word_index) + 1, embedding_dim, weights=[embedding_matrix], input_length=max_sequence_len, trainable=False))

# Using a Bidirectional LSTM layer instead of a unidirectional LSTM layer
...
"""
Test Loss: 0.7951130867004395, Test Accuracy: 0.6737938523292542
"""
